        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
			  ...
			  <li class="active"><i class="icon-file-alt"></i> Make Defaulter List</li>
            </ol>
          </div>
        </div>
		
		<div class="box-content"  style="width:25%;height:150px;margin:50px auto;">
		<form action="report.php" method="post">
		<fieldset>
		<legend>Make Reports</legend>
		
		<div>
		<label class="control-label">Select Subject_Names-</label><br/>
		<input type="checkbox" name="service[]" value="1" />&nbsp;Adavanced Internet Technology<br/>
		<input type="checkbox" name="service[]" value="2" />&nbsp;Multimedia System Design<br/>
		<input type="checkbox" name="service[]" value="3" />&nbsp;Software Architecture<br/>
		<input type="checkbox" name="service[]" value="4" />&nbsp;Distributed Computing<br/>
		<br/>
		
		
		<label class="control-label">Set Criteria-</label>
