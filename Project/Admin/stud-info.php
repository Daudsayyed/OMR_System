       ...
       <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
         <ul class="nav navbar-nav side-nav">
			 ...
			 <li><a href="staff-info.php"><i class="fa fa-users"></i>&nbsp;Staff_info</a></li>
			 <li  class="active"><a href="stud-info.php"><i class="fa fa-user"></i>&nbsp;Student_info</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="profile.php"><i class="icon-dashboard"></i> Dashboard</a></li>              <li class="active"><i class="icon-file-alt"></i> Student_info</li>
            </ol>
          </div>
        </div>
